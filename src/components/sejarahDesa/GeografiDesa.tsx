  ...
  return (
    <div className="container mx-auto px-5 text-justify">
      <div className="" data-aos="fade-left" data-aos-duration="2000">
        ...
        <div className="">
          <p className="mb-3 text-black font-medium mt-5">
            Desa Bandung merupakan salah satu desa di wilayah Kecamatan
            Wonosegoro dengan batas wilayah sebagai berikut:
          </p>
          <ul className="list-disc text-black font-medium ml-10 mb-5">
          ...
          <p className="text-black font-medium  mb-5">
            Luas Wilayah Desa Bandung 333,35 Ha dengan rincian terlihat pada
            tabel berikut :
          </p>
          <p className="text-black font-bold text-center mb-3">
            PENGGUNAAN TANAH
          </p>
          ...
          <p className="text-black font-medium">
            ...
            terbagi menjadi 7 (tujuh) Rukun Warga(RW) dan 21(dua puluh satu)
            Rukun Tangga (RT) sebagaimana tabel berikut:
          </p>
          <p className="text-black font-bold text-center mb-3 mt-3">
      ...
      <div className="" data-aos="fade-right" data-aos-duration="2000">
        ...
        <div className="">
          <p className="mb-3 text-black font-medium mt-5">
            Jumlah penduduk DESA BANDUNG pada bulan September tahun 2023
            sebanyak 3.167 jiwa , yang terdiri dari:
          </p>
          <ul className="list-disc ml-10 mb-5 text-black font-medium">
      ...
      <div className="" data-aos="fade-left" data-aos-duration="2000">
        ...
        <div className="">
          <p className="mb-3 text-black font-medium mt-5">
            ...
            status pemanfaatan lahan pada fasilitas umum menunjukkan masih
            adanya kelemahan pemahaman masyarakat terhadap hukum yang ada saat
            ini. Hal tersebut sebagai akibat dari tidak meratanya tingkat
          ...
          <div className="flex flex-col justify-center items-center mb-5">
            ...
            <p className="mb-3 text-black font-medium mt-5">
              ...
              rehabilitasi sarana pendidikan seperti terlihat dalam tabel
              berikut:
            </p>
            <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400 ">
              <thead className="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
            ...
            <p className="mb-3 text-black font-medium mt-5">
              Dilihat dari tingkat ketaqwaan terhadap Tuhan Yang Maha Esa
              Penduduk DESA BANDUNG 100%,walaupun kadang sesekali sesama pemeluk
              agama Islam muncul permasalahan kecil tentang keyakinan dan tata
              cara beribadah, namun hal tersebut tidak menimbulkan konflik antar
              warga. Adapun jumlah Penduduk Desa Bandung berdasar
              agama/kepercayaan dan sarana ibadah adalah sebagai berikut :
            </p>
      ...
      <div className="" data-aos="fade-right" data-aos-duration="2000">
        ...
        <div className="">
          <p className="mb-3 text-black font-medium mt-5">
            Perekonomian Desa Bandung secara umum didominasi pada sektor
            pertanian yang sistem pengelolaannya masih semi tradisional
            (pengolahan lahan, pola tanam maupun pemilihan komoditas produk
            pertaniannya). Lahan pertanian yang ada di Desa Bandung sebagian
            besar lahan dengan pengairan Irigasi Semi permanen dan hanya
            sebagian kecil lahan yang pengairanya dengan irigasi permanen.Cara
            bertanam sudah cukup Fariasi.Hortikultura menjadi alternatif terbaru
            untuk peningkatan perekonomian warga. Disamping itu warga masyarakat
            ada yang menekuni sektor perdagangan, peternakan dll. Untuk lebih
            jelasnya dapat dilihat pada tabel 10 di bawah ini:
          </p>
